...
class MapBuilder : public MapBuilderInterface {//MapBuilderInterface 实例化
 public:
 ...
 private:
  ...
  std::vector<std::unique_ptr<mapping::TrajectoryBuilderInterface>>    //一个向量，管理所有的TrajectoryBuilderInterface;
                 trajectory_builders_;                                                            //  应该是每一个trajectory对应了该向量的一个元素
